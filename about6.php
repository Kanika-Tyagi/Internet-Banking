	...
	<div>	
				...
				<form action="calculation.php" method="POST" style="text-align:center;" >
					...
					<select id="receiver" name="receiver"  required>
						   <option value="Kanika Tyagi">KANIKA TYAGI</option>
						   <option value="Ronak Tyagi">RONAK TYAGI</option>
						   <option value="Jainit Tyagi">JAINIT TYAGI</option>
						   <option value="Ria Tyagi">RIA TYAGI</option>
						   <option value="Srishti Dabral">SRISHTI DABRAL</option>
						   <option value="Nikita Shokeen">NIKITA SHOKEEN</option>
						   <option value="Nitya Saini">NITYA SAINI</option>
						   <option value="Riya Khushwha">RIYA KHUSHWHA</option>
						   <option value="Kamya">KAMYA</option>
						   <option value="Chirag Tyagi">CHIRAG TYAGI</option>
					</select>
					<br>
					<br>
					<b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Amount :</b>
